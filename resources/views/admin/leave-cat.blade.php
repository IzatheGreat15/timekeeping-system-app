...
<div class="container bg-light p-3 p-sm-5 mb-5 shadow-lg" style="color:#767070;">
    ...
    <!-- Form Search -->
    <form method="POST" action="/leave-category-search">
        @csrf
        <div class="form-row">
            ...
            <div class="col-md mb-3">
                <label>Search</label>
                <input type="text" name="main_leave_info" class="form-control">
            </div>
        </div>
    </form>
                ...
                <tbody>
                    @if ($leaves->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-clear p-0" href="/leave-category-details/{{ $leave->id }}">
                                ...
                                &nbsp;
                                <a class="btn btn-clear p-0" href="/leave-category-edit/{{ $leave->id }}">
                    ...
                    @else
                        <tr>
                            <td colspan="5">No leaves available yet!</td>
                        </tr>
                    @endif
                </tbody>
            </table>
...
<div class="modal fade delete-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content p-3 text-center">
            ...
            <form method="POST" action="/main-leave-delete">
                @csrf
