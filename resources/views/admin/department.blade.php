...
<div class="container bg-light p-3 p-sm-5 mb-5 shadow-lg" style="color:#767070;">
    ...
    <!-- Form Search -->
    <form method="POST" action="/department-search">
        @csrf
        <div class="form-row">
            <div class="col-sm mb-3">
                <!--Redirect to department-new.blade.php-->
                <a type="button" class="btn shadow-md mb-4" href="/department-new" style="color:white">
            ...
            <div class="col-md mb-3">
                <label>Search</label>
                <input type="text" name="dept_info" class="form-control">
            </div>
        </div>
    </form>
                ...
                <tbody>
                    @if ($departments->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>{{ Str::limit($dept->description, 20) }}</td>
                            <td>
                                <a class="btn btn-clear p-0" href="/department-edit/{{ $dept->id }}">
                    ...
                    @else
                        <tr>
                            <td colspan="4">No departments available yet!</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="modal-content p-3 text-center">
            ...
            <form method="POST" action="/department-delete">
                ...
                <p>Are you sure you want to delete 
                    <br>
                    <strong id="dept_name"></strong> Department?</p>
