...
<div class="container bg-light p-3 p-sm-5 mb-5 shadow-lg" style="color:#767070;">
    ...
    <a type="button" class="btn shadow-md mb-3" href="/shift-change-new" style="color:white">
    ...
    <!--Form Date Filter-->
    <form method="POST" action="/shift-change-search">
        @csrf 
        <div class="form-row">
            ...
            <table class="table table-hover text-center" id="dept_table">
                ...
                @if($requests->count() > 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-clear p-0" href="/shift-change/{{ $req->id }}">
                            ...
                            <a class="btn btn-clear p-0" href="/shift-change-edit/{{ $req->id }}">
...
<div class="modal fade delete-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content p-3 text-center">
            ...
            <form method="POST" action="/shift-change-delete">
                @csrf 
