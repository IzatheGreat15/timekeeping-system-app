            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="manageSubmenu">
                        <li>
                            <a href="#">Approve Adjustments</a>
                        </li>
                        <li>
                            <a href="#">Approve Shift Change</a>
                        </li>
                        <li>
                            <a href="#">Approve Leaves</a>
                        </li>
                        <li>
                            <a href="#">Approve Overtimes</a>
                        </li>
                        <li>
                            <a href="#">Manage Shifts</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark navbar-default navbar-fixed-top">
                <div class="container-fluid">
                    <!--Toggle-->
                    <button type="button" id="sidebarCollapse" class="btn" style="background-color: transparent; color:white">
